      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-600">
            Here&apos;s what&apos;s happening to your boards today .
          </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">
                    {
                      boards.filter((board) => {
                        const updated_at = new Date(board.updated_at);
                        const oneWeekAgo = new Date();
                        oneWeekAgo.setDate(oneWeekAgo.getDate() - 7);
                        return updated_at > oneWeekAgo;
                      }).length
                    }
                  </p>
                </div>
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-stretch sm:justify-between space-y-2 sm:space-y-0">
